/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/andres/Descargas/BeagleBoard/poky-dylan-9.0.3/build/tmp/work-shared/gcc-4.7.2-r20/gcc-4.7.2/gcc/config/arm/arm.md'.  */
